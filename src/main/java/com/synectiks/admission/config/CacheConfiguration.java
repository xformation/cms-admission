...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.synectiks.admission.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.synectiks.admission.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(com.synectiks.admission.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.synectiks.admission.domain.Authority.class.getName(), jcacheConfiguration);
