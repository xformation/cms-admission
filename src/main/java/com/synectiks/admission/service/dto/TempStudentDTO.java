...
/**
 * A DTO for the {@link com.synectiks.admission.domain.TempStudent} entity.
 */
public class TempStudentDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        TempStudentDTO tempStudentDTO = (TempStudentDTO) o;
        if (tempStudentDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), tempStudentDTO.getId());
    }
