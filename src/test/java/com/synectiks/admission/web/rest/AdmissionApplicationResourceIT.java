...
public class AdmissionApplicationResourceIT {
    ...
    public void createAdmissionApplication() throws Exception {
        ...
        assertThat(testAdmissionApplication.getAcademicYearId()).isEqualTo(DEFAULT_ACADEMIC_YEAR_ID);
    ...
    public void updateAdmissionApplication() throws Exception {
        ...
        assertThat(testAdmissionApplication.getAcademicYearId()).isEqualTo(UPDATED_ACADEMIC_YEAR_ID);
